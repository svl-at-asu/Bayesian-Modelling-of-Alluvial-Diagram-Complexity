...
| ------------- | ------------- | ------------- | ------------- |
| Most Active Timestep  | -0.36615822  | -0.22544675 | -0.22544675 |
| Largest Entity  | -0.60315806  | -0.5116268 | -0.5116268 |
| Largest Flow  | -0.52775928  | -0.37506516 | -0.37506516 |
| Most Active Entity  | -0.4728622  | -0.31203823 | -0.31203823 |
...
| T1 | Most Active Timestep | 1.096 | 0.582 | 1.374 | 0.634 | 1.356 | 0.587 | 1.185 | **0.668** | 1.280 | 0.637 |
| T2 | Largest Entity | 0.758 | 0.566 | 0.955 | 0.624 | 0.943 | 0.578 | 0.814 | **0.641** | 0.886 | 0.621 |
| T3 | Largest Flow | 1.004 | 0.639 | 1.242 | 0.678 | 1.212 | 0.614 | 1.075 | **0.720** | 1.160 | 0.684 |
| T4 | Most Active Entity | 0.845 | 0.587 | 1.067 | 0.648 | 1.067 | 0.648 | 0.920 | **0.682** | 0.991 | 0.647 |
...
- We multiply or divide the conditional probabilities among features by the corresponding w<sub>i</sub>'s of the considered features (based on whether they are the conditioning or preceding variables respectively) when calculating P(Comp<sub>a</sub>/t<sub>a</sub>,e<sub>a</sub>,f<sub>a</sub>,c<sub>a</sub>) to account for the varying contributions of each feature to determining complexity.
